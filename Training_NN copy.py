...
if __name__ == "__main__":
    ...
    # Build neural network
        ...
        print("---- Start traing data {} ----".format(i))
        ...
        for epoch in range(num_epoch):
            ...
            for inputs, labels in train:
                ...
                if epoch == num_epoch - 1:
                    ...
                    for i,v in enumerate(labels):
                        if v == 1:
                            if predicted != i:
                                print("uncorrect on classes{}, predicted wrong is {}".format(i, predicted))
            ...
            #print()
        torch.save(model.state_dict(), prefix + '/model2.pth')